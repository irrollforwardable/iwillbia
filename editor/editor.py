    ...
    def click_sql(self):
        ...
        for word in word_list:
            ...
            words_insert = SqlInsertStatement("words", (
                ...
                ColumnTypeValue("language_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.header.language_panel.get_kept_id()),
                ColumnTypeValue("immediate_changes_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.header.immediate_changes.get_kept_id()),
                ColumnTypeValue("command_1_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_1.get_kept_id()),
                ColumnTypeValue("command_2_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_2.get_kept_id()),
                ColumnTypeValue("command_3_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_3.get_kept_id()),
                ColumnTypeValue("command_4_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_4.get_kept_id()),
                ColumnTypeValue("command_5_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_5.get_kept_id()),
                ColumnTypeValue("command_6_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_6.get_kept_id()),
                ColumnTypeValue("command_7_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_7.get_kept_id()),
                ColumnTypeValue("command_8_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_8.get_kept_id()),
                ColumnTypeValue("command_9_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_9.get_kept_id()),
                ColumnTypeValue("command_0_action_id", COL_TYPE_NUMBER,
                                self.word_editor_panel.details.actions_panel.action_0.get_kept_id())))
